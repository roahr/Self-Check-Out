...
bg=ImageTk.PhotoImage(file = r"Self-Check-Out\resource\3.png")
frame = tk.Frame(win)
...
def but1_cmd():
    ...
    c=30
    f=open("stock.txt","w")
    img = cv2.imread(r"Self-Check-Out\resource\4.png", cv2.IMREAD_COLOR)
...
def but2_cmd():
    ...
    win2.geometry("626x417")
    bg2=ImageTk.PhotoImage(file = r"Self-Check-Out\resource\1.png")
